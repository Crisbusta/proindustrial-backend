...
(
  ...
  'Talca', 'Maule',
  ARRAY['termofusion'],
  ARRAY['Termofusión PEAD a tope y electrofusión','Redes de agua potable rural','Sistemas de riego tecnificado','Instalación en zanjas y microtunel'],
...
-- Seed users (password = "demo123" bcrypt hash)
-- Hash generated with: bcrypt("demo123", cost=10)
INSERT INTO users (email, password_hash, company_id) VALUES
  ('contacto@acerospacifico.cl',     '$2a$10$r1zFxutzHJAHUYG.5UCOdeh4AyJru1vWjfhG3sklvd9Ml0JTILRWy', (SELECT id FROM companies WHERE slug='proveedora-aceros-pacifico')),
  ('proyectos@tuberiasdelsur.cl',    '$2a$10$r1zFxutzHJAHUYG.5UCOdeh4AyJru1vWjfhG3sklvd9Ml0JTILRWy', (SELECT id FROM companies WHERE slug='tuberias-del-sur')),
  ('info@electroindustrial.cl',      '$2a$10$r1zFxutzHJAHUYG.5UCOdeh4AyJru1vWjfhG3sklvd9Ml0JTILRWy', (SELECT id FROM companies WHERE slug='electro-industrial-spa')),
  ('obras@hormigonsur.cl',           '$2a$10$r1zFxutzHJAHUYG.5UCOdeh4AyJru1vWjfhG3sklvd9Ml0JTILRWy', (SELECT id FROM companies WHERE slug='hormigonsur')),
  ('contacto@hidronorte.cl',         '$2a$10$r1zFxutzHJAHUYG.5UCOdeh4AyJru1vWjfhG3sklvd9Ml0JTILRWy', (SELECT id FROM companies WHERE slug='hidro-norte')),
  ('ventas@geomembranasatacama.cl',  '$2a$10$r1zFxutzHJAHUYG.5UCOdeh4AyJru1vWjfhG3sklvd9Ml0JTILRWy', (SELECT id FROM companies WHERE slug='geomembranas-atacama')),
  ('info@fusionespacifico.cl',       '$2a$10$r1zFxutzHJAHUYG.5UCOdeh4AyJru1vWjfhG3sklvd9Ml0JTILRWy', (SELECT id FROM companies WHERE slug='fusiones-pacifico')),
  ('licitaciones@montajesvalparaiso.cl', '$2a$10$r1zFxutzHJAHUYG.5UCOdeh4AyJru1vWjfhG3sklvd9Ml0JTILRWy', (SELECT id FROM companies WHERE slug='montajes-valparaiso'));

-- Seed quote requests for featured companies
...
-- Seed company services for featured companies
